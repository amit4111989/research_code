...
def test_dA(learning_rate=0.001, training_epochs=1000,
    ...
    # testx = test_set_x.get_value()
    # test_set_x = []
    # for i in testx:
    #     test_set_x.append(i[120:150])
    ...
    #     cost,
    #     givens={
    #         x: random_data[index * batch_size: (index + 1) * batch_size]
    #     }
    # )
